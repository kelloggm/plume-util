...
public class LimitedSizeLongSet implements Serializable, Cloneable {
   ...
   */
  public LimitedSizeLongSet(int maxValues) {
   ...
   */
  public int size(LimitedSizeLongSet this) {
    return numValues;
  }
   ...
   */
  public boolean repNulled(LimitedSizeLongSet this) {
    return values == null;
  }
  ...
  @Override
  public LimitedSizeLongSet clone(LimitedSizeLongSet this) {
   ...
   */
  public static LimitedSizeLongSet merge(int maxValues, List<LimitedSizeLongSet> slist) {
  ...
  @Override
  public String toString(LimitedSizeLongSet this) {
