...
@SuppressWarnings({
        "IterableAndIterator",
        "objectconstruction:required.method.not.called" // FP container of owners: generic collection of owned resources `readers` (validated)
})
public class EntryReader extends LineNumberReader implements Iterable<String>, Iterator<String> {
   ...
   * @return a line-by-line iterator for this file
   */
  @SuppressWarnings("mustcall:override.return") // FP container of owners: `Iterable.iterator()` returns @MustCall (validated)
  @Override
