...
public final class Intern {
  ...
  public static long[] internSubsequence(
    ...
    if (result1 != null) {
      ...
      long[] subseq = Intern.intern(subseqUninterned);
  ...
  public static double[] internSubsequence(
    ...
    if (result1 != null) {
      ...
      double[] subseq = Intern.intern(subseqUninterned);
  ...
  public static Object[] internSubsequence(
    ...
    if (result1 != null) {
      ...
      Object[] subseqUninterned = ArraysPlume.subarray(seq, start, end - start);
      Object[] subseq = Intern.intern(subseqUninterned);
  ...
  public static String[] internSubsequence(
    ...
    if (result1 != null) {
      ...
      String[] subseqUninterned = ArraysPlume.subarray(seq, start, end - start);
      String[] subseq = Intern.intern(subseqUninterned);
      @SuppressWarnings({"nullness", "UnusedVariable"}) // safe because map does no side effects
      Object
          ignore = // assignment just so there is a place to hang the @SuppressWarnings annotation
